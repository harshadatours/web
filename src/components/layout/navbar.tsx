...
export function Navbar() {
  ...
  return (
    <header
      className={cn(
        'fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-2 sm:px-4 md:px-8 py-2.5 sm:py-4',
        isScrolled ? 'top-1 sm:top-2' : 'top-0'
      )}
    >
      <nav
        className={cn(
          'max-w-7xl mx-auto rounded-full transition-all duration-300 px-3.5 sm:px-6 py-2 sm:py-3 flex items-center justify-between',
